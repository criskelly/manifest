...
<meta charset="UTF-8">
<title>Find local bands and musicians by city and state</title>

<meta name="description" content="The Manifest is a nationwide directory of bands and musicians that allows you to find local musicians in almost every city and state." />
			...
			<div id="main">
				...
				<div id="state-listing-right" class="states">
					<ul id="o-z-states">
						...
						<ul class="disappear">
							<li class="city"><a href="or-ashland.php">Ashland</a></li>
						...
						<li class="state">Rhode Island</li>
						<ul class="disappear">
						...
						<li class="state">South Carolina</li>
						<ul class="disappear">
				...
				<div id="provinces">
					<ul id="province-list">
						...
						<li class="state">Nunavut</li>
						<li class="state">Ontario</li>
						<li class="state">Prince Edward Island</li>
						<li class="state">Quebec</li>
						<li class="state">Saskatchewan</li>
						<li class="state">Yukon</li>
					</ul>
				</div>
			</div>	<!-- end main -->
		</div>
